...
var layout_model;
var img_choose;
var img_choose_loading;
var img_uploading_li;
...
$(document).ready(function(){
	...
	$(".model2_Bg:eq(3)").bind("click",function(){
		$(".logo").attr("src",$(".model2_Bg:eq(2)").val());
		})
	/*导航条背景颜色*/
	...
	function main_hiddenB(){
		...
		/*标签字体大小*/
		var main_hiddentextsize;var main_hiddentextsizeB;
	    $(".main_hiddentextsizeB").click(function(){
		    main_hiddentextsizeB=$(this).index(".main_hiddentextsizeB");
		    main_hiddentextsize=$(".main_hiddentextsize:eq("+main_hiddentextsizeB+")").val()+'px';
		    $(".model_Product11text:eq("+main_hiddentextsizeB+")").css("font-size",main_hiddentextsize);
		    })
		/*标签字体颜色*/
		...
		/*图片选择*/
		function img_choose_loading(){
		$(".img-preview:eq(0)").show();
		$(".img-choose").click(function(){
			img_choose=$(this).index(".img-choose");
			$(".img-uploading-position").show();
			})
		$(".img-uploading-close img").click(function(){
			$(".img-uploading-position").hide();
			})
		$(".img-uploading-li").click(function(){
			img_uploading_li=$(this).index(".img-uploading-li");
			$(".img-preview").hide();
			$(".img-preview:eq("+img_uploading_li+")").show();
			$(".img-uploading-li").css({"color":"#3366cc","background-color":"#e5f0ff"});
