    ...
    <div class="seller_main">
      ...
      <div class="qualification">
        <form id="form_info" action="{:U('shop_offline_info')}" method="post">
          <div class="formhead fonrm"> <strong>线上审核证</strong>
          </div>
          <h5>会员信息校验</h5>
          <dl>
            <dt>
            ...
            <dd>
              <strong>{$userinfo['username']}111</strong>
            </dd>
            <dt>
              手 机 号 码： <em></em>
            </dt>
            <dd>
              <strong>{$userinfo['mobile']}222</strong>
            </dd>
            ...
            <div class="form">
              ...
              <dl class="chconli" <eq name="userinfo[type]" value="0">style="display:none;"</eq><eq name="userinfo[type]" value="2">style="display:none;"</eq>>
                ...
                <dd>
                  ...
                  证件号：
                  <input class="inptverify" type="text" class="card" name="idcard" value="{$userinfo.idcard}" />
                </dd>
                <dt>
                  证件所在地：
                  <em></em>
      ...
      <p class="care">
        ...
        <br>通常需要1-2个工作日，审核一旦通过，我们将尽快告知您，请保证通信畅通。</p>
    </div>
  </div>
