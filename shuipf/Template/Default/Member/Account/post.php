...
<body>
  ...
  <eq name="step" value="1">
    <div class="seller_accountmain">
      ...
      <div class="verify">
        ...
        通过“手机验证码+证件号码”
        <a href="{:U('post',array('step'=>2,'type'=>1))}" class="btn_verify">立即认证</a>
      </div>
      <div class="verify">
  ...
  <eq name="step" value="2">
    <div class="seller_accountmain">
      ...
      <form id="form_verify" action="{:U('post')}" method="post">
        <dl>
          <dt>您的手机：</dt>
          <dd>
          ...
          <dd>
            ...
            <a class="return" href="{:U('post')}">重新选择验证方式</a>
          </dd>
        </dl>
      </form>
      <div class="tip">
  ...
  <eq name="step" value="3">
    ...
    <div class="seller_accountmain">
      <div class="processb">
        ...
        <span class="tit titred">验证身份</span>
        <span class="tit titred">添加邮箱</span>
        <span class="tit">完成</span>
      </div>
      <h6>请确保您输入的邮箱能正常接收激活邮件，邮箱才能生效</h6>
      <form id="form_add_post" action="{:U('post')}" method="post">
        <dl>
          <dt>登录名：</dt>
          <dd>
            <input type="text" class="phone" value="{$userinfo['mobile']}" disabled="true"></dd>
          <dt>邮箱：</dt>
          <dd>
          ...
          <dd>
            ...
            <a class="sure" href="javascript:$('#form_add_post').submit()">确定</a>
          </dd>
        </dl>
      </form>
      <div class="tip">
