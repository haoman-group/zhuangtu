          ...
          <li loc="1">
            <div id='box_0_0' class="selected boxGoogleList">
              ...
              <div class="result_summary">
                ...
                <div class="sp"><a href="{:getCategory($r['catid'],'url')}" target="_blank" style="color:#999">{:getCategory($r['catid'],'catname')}</a></div>
              </div>
...
<div id="footer" ss_c="tshh">
  <p><a href="http://www.abc3210.com/2012/work_06/shuipfcms-faq.shtml" target="_blank" >帮助中心</a>|<a href="http://www.abc3210.com/2012/work_05/1.shtml" target="_blank" >反馈建议</a>|<a href="http://www.abc3210.com" target="_blank">ShuipFCMS</a></p>
  Copyright &copy; 2012 - 2013 abc3210.com. All Rights Reserved. </div>
