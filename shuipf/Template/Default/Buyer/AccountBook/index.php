...
<div class="container buyercenter_wrap scindex">
    ...
    <div class="wraprt">
        ...
        <div class="accborder">
            <form  method="post" id="formaddacount" name="formaccount">
                <ul class="accul">
                <li>
                ...
                <li>
                    ...
                    <div class="accform">
                        ...
                        <div class="explaininput" data-type="23">
                            <img src="{$config_siteurl}statics/zt/images/buyercenter/accountbook-23.png">
                            <p><input type="radio" name="radiobutton" value="23"></p>
                        </div>
...
<script>
    ...
    $("#commit").click(function(){
        ...
        var picture=$(this).parents(".accul").find("#hd_picture").val();
