...
<div class="container buyercenter_wrap scindex">
    ...
    <div class="wraprt">
       <if condition="strpos($_SERVER['PHP_SELF'], 'refundsearch') eq true"><else/>
        ...
        <div class="productsell_sear">
          <form id="searchoptions" method="post" action="ordersearch">
                    ...
                    <tr class="title">
                        <td colspan="7">
                            <h6>
                                ...
                                <a href="/s/{$vo.shop.domain}" target="_blank" title="{$vo.shop.name}" class="shop"><i>{$vo.shop.name}</i><img src="{$config_siteurl}statics/zt/images/buyercenter/chat.png" alt="联系卖家" /></a>
