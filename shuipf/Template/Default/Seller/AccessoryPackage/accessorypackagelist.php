  ...
  <div class="container sellercenter_wrap scindex">
    ...
    <div class="wraprt">
      <div class="crumbs">
        ...
        <a href="{:U('Seller/Index/index')}" class="icon-ajx">辅材包</a>
        <!-- <a href="#" class="icon-ajx"> > </a>
        <a href="{:U('Seller/Product/lists')}" class="icon-ajx">出售中的宝贝</a>
        <a href="#" class="icon-ajx"> </a> -->
      </div>
      <div class="productsell_count">
        <a class="package" href="{:U('Seller/AccessoryPackage/add',array(inpcid=>124886060))}">去发布辅材包</a>
      </div>
          ...
          <volist name="lists" id="vo">
            <ul class="list">
              ...
              <li>
                ...
                <p><a class="acopy" href="javascript:void(0)" data-prolink="{:U('Seller/AccessoryPackage/accessorypackageshow',array('id'=>$vo['id']))}" >复制链接</a></p>
              </li>
            </ul>
          </volist>
<!--------------------------->
