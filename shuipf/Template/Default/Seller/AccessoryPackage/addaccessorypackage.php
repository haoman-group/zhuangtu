  ...
  <div class="productdetail_box">
    ...
    <div class="rightbox">
      ...
      <dl>
        <dt><i>*</i>宝贝标题：</dt>
        <dd class="title">
          <!-- <input type="text" value="水电施工辅材包"> -->
          <select name="title" class="ignore">
          <option value="水电施工辅材包">水电施工------辅材包</option>
          <option value="铺地贴砖辅材包">铺地贴砖------辅材包</option>
         <option  value="吊顶木工辅材包">吊顶木工------辅材包</option>
         <option  value="刮家刷漆辅材包">刮家刷漆------辅材包</option>
        </select>
      </dd>
        <dt><!-- <i>*</i> -->宝贝卖点：</dt>
...
function submitadd(){
  ...
  // return true;
    ...
    var url = "/Seller/AccessoryPackage/" + action +"?id=" + id;
    $.ajax({
      url:url,
      type:"post",
