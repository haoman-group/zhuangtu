...
<link rel="stylesheet" type="text/css" href="{$config_siteurl}statics/zt/css/shopskin/dark.css" >
...
<div class="page">
	<div class="ztshopcon">
		<div class="layoutmain" data-maxlayout="5" data-maxmods="40">
			<div class="layout-hd <eq name="page[setting][header][isshownav]" value="0">hdhidenav</eq> " style="margin-bottom: <eq name="page[setting][header][margin_bottom_10]" value="0">0px <else/>10px</eq>; <eq name="page[setting][header][isshowhead]" value="0">display:none;</eq>  ">
				<div class="headhrbg" data-oh="150" style="background-image: url({$page['setting']['header']['background_image']}); <notempty name="page[setting][header][background_color]">background-color:{$page['setting']['header']['background_color']};</notempty>  background-repeat:{$page['setting']['header']['background_repeat']};background-position:{$page['setting']['header']['background_align']} 0;height:{$page['setting']['header']['height']|default=150}px; ">
					<div class="navhrbg"></div>
				</div>
				<div class="layout layout-block" data-ltype="ltop" data-widgetid="12346745822" data-componentid="23" data-prototypeid="23" data-id="12346745822" data-max="2">
					<div class="col-main">
						<div class="main-wrap J_TRegion" data-modules="main" data-width="h950" data-max="2">
							<!--
							<div class="J_TModule" data-widgetid="12350952761" id="shop12350952761" data-componentid="8820" data-spm="110.0.8820-12350952761" microscope-data="8820-12350952761" data-title="店铺招牌" data-context="h950" data-ismove="1" data-isdel="1" data-isedit="1" data-isadd="1" data-width="909" data-uri="/module/moduleForm.htm?widgetId=12350952761&amp;sid=340908835&amp;pageId=1147566751">
								<div class="banbox">
									<h2 class="shoptitle">{$shop['name']}</h2>
								</div>
							</div>

							<div class="J_TModule tb-module nav_module" data-widgetid="12346745824" data-componentid="5002" data-spm="'110.0.5002-12346745824'" microscope-data="'5002-12346745824'" data-title="导航" data-context="h950" data-ismove="0" data-isdel="0" data-isedit="0" data-isadd="0" data-width="650" data-uri="/module/moduleForm.htm?widgetId=12346745824&amp;sid=340826219&amp;pageId=1147251295">
								<div class="nav">
...
function styleset(act,css){
	if(act==="header"){
		console.log(111);
		console.log(css);
		$(".headhrbg").css({"background-color":css.background_color,"background-image":css.background_image,"background-repeat":css.background_repeat,"background-position":css.background_position+" 0"});
