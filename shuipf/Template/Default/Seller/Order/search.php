    ...
    <div class="wraprt">
      ...
      <ul class="goodsstatus">
        <li <empty name="_GET['order_state']">class="on"</empty>><a href="{:U('index')}">所有订单</a></li>
            ...
            <li <if condition="$_GET[order_state] eq ORDER_STATE_PAY">class="on"</if>><a href="{:U('index',array('order_state'=>ORDER_STATE_PAY))}">等待发货</a></li>
            <li <if condition="$_GET[order_state] eq ORDER_STATE_SEND">class="on"</if>><a href="{:U('index',array('order_state'=>ORDER_STATE_SEND))}">等待安装</a></li>
            <li <if condition="$_GET[order_state] eq ORDER_STATE_SETUP">class="on"</if>><a href="{:U('index',array('order_state'=>ORDER_STATE_SETUP))}">待确认</a></li>
          ...
          <div class="goods_list">
            ...
            <div class="border">
                ...
                <ul class="cost">
                  ...
                  <li><a href="" class="cost_image"><img src="{$vo.goods_image|thumb=###,'88','88','0'}" style="width:88px;height:88px;"></a><div class="describe"><a href="">{$vo.goods_name}</a>
                    <div>
                  ...
                  <li>{$vo.goods_num}</li>
                  <li>￥{$vo.goods_price}</li>
                  <li>￥{$vo.goods_pay_price}</li>
                  <li>{$vo.buyer_name}<a href=""><!-- 联系买家 --></a></li>
                     <switch name="vo['order_state']">
                      <case value="10">
                        <li>
                          {$status[0][$cat_pid]}<a href="{:U('detail',array('order_sn'=>$vo['order_sn']))}">订单详情</a>
                        <li>
                          <a class="changePrice" data-recid="{$v.rec_id}" data-ordersn="{$vo.order_sn}" style="cursor:pointer">改价</a>
                          <!-- <a href="javascript:void(0)" class="cancelOrder" data-orderSn="{$vo.order_sn}"><span class="Cancel_Order">取消订单</span></a></li> -->
                        </li>
                      </case>
                      <case value="20">
                        <li>
