                      ...
                      <div class="price">
                         ...
                         <!--  <div class="txtdt ">
                          ...
                          <div class="txtdd zt_price">
                              ...
                              <strong>￥{$priceRange.price_act_min|sprintf='%.2f',###} <if condition="$priceRange['price_act_min'] neq $priceRange['price_act_max']"> - {$priceRange.price_act_max|sprintf='%.2f',###}</if></strong>
                              <span class="tipe">根据实际报价确定报价金额</span>
                          </div>
<!--                          <div class="txtdt">-->
<!--                              本店活动-->
<!--                          </div>-->
