  ...
  <div class="container sellercenter_wrap scindex">
    ...
    <div class="wraprt">
      <div class="crumbs">
        ...
        <a href="{:U('Seller/Index/index')}" class="icon-ajx">主材包</a>
        <!-- <a href="#" class="icon-ajx"> > </a>
      ...
      <div class="productsell_count">
        ...
        <div class="body">
          <div class="cposition">
            <h4><a href="{:U('Seller/MaterialPackage/add',array(inpcid=>124886059))}">去发布主材包</a></h4>
          </div>
        </div> -->
        <a class="package" href="{:U('Seller/MaterialPackage/add',array(inpcid=>124886059))}">去发布主材包</a>
      </div>
            <!-- <h4>橱窗位</h4>
...
<!--          <input type="button" value="取消推荐" data-action="{:U('unsetshowcase')}" onclick="submitaction(this)">-->
          ...
          <volist name="lists" id="vo">
            <ul class="list">
              ...
              <li><empty name="vo['number']">--<else/>{$vo.number}</empty></li>
              ...
              <li>
                ...
                <p><a class="acopy" href="javascript:void(0)" data-prolink="{:U('Seller/MaterialPackage/materialpackageshow',array('id'=>$vo['id']))}" >复制链接</a></p>
              </li>
            </ul>
          </volist>
<!--------------------------->
