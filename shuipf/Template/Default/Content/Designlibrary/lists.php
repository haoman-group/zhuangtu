...
<div class="scale">
  ...
  <div class="sjk_nav">
      <ul>
        ...
        <li>
          <a <if condition="$vo eq $_GET['style']"> class ="active" </if>href="{:(U('lists',array('style'=>$vo)))}">{$vo}</a>
        </li>
        </volist>
      </ul>
  </div>
                ...
                <li>
                  <a href="{:U('Designlibrary/show',array('proid'=>$data['proid']))}">
                    ...
                    <p class="tit"><strong>【{$data['style']}】</strong><span <if condition='$data["likecount"] neq 0'>class="likecount"</if>>{$data['likecount']}</span>
                      <if condition="$data['collectnum'] eq 0"><i class="collect" data-proid={$data['proid']} data-userid={$data['userid']} data-isdelete='1' data-type="1">收藏夹</i><else/>
                      <i class="collected" data-proid={$data['proid']} data-userid={$data['userid']} data-isdelete='0' data-type="1">已收藏</i></if>
                      </p>
                    ...
                    <div class="company">
                      ...
                      <if condition="$data['likecount'] eq 0">
                       <strong class="like" data-proid="{$data['proid']}" data-userid="{$data['userid']}" data-type="1" data-isdelete="1">喜欢TA</strong>
                      <else/>
                       <strong class="liked" data-proid="{$data['proid']}" data-userid="{$data['userid']}" data-type="1" data-isdelete="0">取消</strong>
                      </if>
                    </div>
