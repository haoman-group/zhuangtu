...
<div class="designerstencil1">
    <div class="banner">
        <dl class="container">
            <dt>
                ...
                <p>Adele从业8年后成立云想衣裳室内设计工作室，</p>
                <p>一直以“磨合个性家居”为自己的座右铭。</p>
            </dt>
            <dd>
                <img src="{$config_siteurl}statics/zt/images/designerstencil1_bannerperson.jpg"><br>
    ...
    <div class="introduce">
        ...
        <p><span>设计风格：</span><a href="">中式</a><a href="">欧式</a><a href="">田园</a><a href="">现代</a><a href="">简约</a><a href="">混搭</a><a href="">地中海</a></p>
        <p><span>设计心语：</span>走个性化路线,需要更耐心地与业主磨合</p>
    </div>
    <div class="ul">
        <div class="li">
            <img src="{$config_siteurl}statics/zt/images/designerstencil1libg1.jpg">
            <div class="bottom">
