...
<head>
    ...
    <script type="text/javascript" src="../js/base_jquery.js"> </script>
    <script type="text/javascript" src="../js/sellercenter.js"> </script>
</head>
<body>
<!--背景容器-->
    ...
    <div class="box">
            ...
            <div class="main">
                <div class="explain">
                    ...
                    <div class="explain_box">
                        <img class="photo" src="{$config_siteurl}statics/zt/images/designerstencil3_mainpersonphoto.jpg">
                        <p class="name">adkow</p>
                        <p>Adele从业8年后成立云想衣裳室内设计工作室，一直以“磨合个性家居”为自己的座右铭</p>
                        <p><span>从业时间：</span>12年以上<span>设计擅长：</span><a href="">公寓</a><a href="">别墅</a></p>
                        <p>我们致力于室内设计以及装修顾问服务、精拓实业，并不断追求宽广的业务，只求精益求精。数年来曾为改变！</p>
        ...
        <div class="production">
            ...
            <div class="production_box">
                <ul>
                <li>
                    <img class="li" src="{$config_siteurl}statics/zt/images/designerstencil3_mainproductionli1.jpg">
                    <div class="bottom">
        ...
        <div class="case">
            ...
            <ul>
                <li>
                    <img src="{$config_siteurl}statics/zt/images/designerstencil3_maincaseli4.jpg">
                    <a href="">立即购买</a>
                ...
                <li>
                    <img src="{$config_siteurl}statics/zt/images/designerstencil3_maincaseli2.jpg">
                    <a href="">立即购买</a>
                    <p class="style">现代简约风</p>
                    <p class="area">96㎡两室一厅</p>
                    <p class="introduce">恋上地中海的夏日转角</p>
                ...
                <li>
                    <img src="{$config_siteurl}statics/zt/images/designerstencil3_maincaseli3.jpg">
                    <a href="">立即购买</a>
                    <p class="style">现代简约风</p>
                    <p class="area">96㎡两室一厅</p>
                    <p class="introduce">恋上地中海的夏日转角</p>
                ...
                <li>
                    <img src="{$config_siteurl}statics/zt/images/designerstencil3_maincaseli1.jpg">
                    <a href="">立即购买</a>
                    <p class="style">现代简约风</p>
                    <p class="area">96㎡两室一厅</p>
                    <p class="introduce">恋上地中海的夏日转角</p>
