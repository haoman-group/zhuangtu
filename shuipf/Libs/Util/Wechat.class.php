...
class Wechat
{
	...
	{
		$this->token = isset($options['token'])?$options['token']:'fxz12345';
		$this->encodingAesKey = isset($options['encodingaeskey'])?$options['encodingaeskey']:'o30aBNmeYZAupamqPVr5OrBiWePNzfIGDMJybw2EuDP';
		$this->appid = isset($options['appid'])?$options['appid']:'wxc140a63e95a98a26';
		$this->appsecret = isset($options['appsecret'])?$options['appsecret']:'adb32f61be5972b9ee8dcc76d80d7047';
