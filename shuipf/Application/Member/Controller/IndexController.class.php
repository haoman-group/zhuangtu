...
class IndexController extends MemberbaseController {
    ...
    public function index() {
        if($this->shopid) $this->redirect('Member/Seller/index');
        // redirect(U('Account/secure'));
        if($this->userinfo['isbuyer'] == '1'){
            redirect('/Buyer/Index/index');
        }else{
            redirect('/Seller/Index/index');
        }
    }
