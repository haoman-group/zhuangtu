...
class YanshouController extends SellerbaseController {
    ...
    public function add(){
      if(IS_POST){
        ...
        $this->assign('category',$this->_getCateTypeForWorker());
        $this->display('Product/addYanshou');
      }
    }
    ...
    private function _procData(){
        ...
        //从业年限
        $workyears = I('workyears','0');
        //工人籍贯
        $hometown = I('hometown');
        //联系电话
        $phone = I('phone');
        //卖点
        $sell_points = I('sell_points');
        //成功案例
