                ...
                <span class="mr20">
                         <table>
                             <tr>
                                 <td>
                                     <span >订单号：</span>
                                     <input name="order_sn" type="text"  class="input"  value="">
                                 </td>
                                 <!-- <td>
                                     <span >支付号：</span>
                                 ...
                                 <td>
                                     <span>店铺名称：</span>
                                     <input name="shopname" type="text"  class="input" value="">
                                 </td>
                                  <td>
                                     <span>店铺ID：</span>
                                     <input name="shop_id" type="text"  class="input" value="">
                                 </td>
                                 <!-- <td class="range">
                                     <span> 订单总额：</span>
                             ...
                             <tr>
                                 <td>
                                     <span>评论人名：</span>
                                     <input name="username" type="text"  class="input" value="">
                                 </td>
                                 <td>
                                     <span>评论人ID：</span>
                                     <input name="userid" type="text"  class="input" value="">
                                 </td>
                                 <td>
                                     <span>产品ID：</span>
                            <input name="productid" type="text"  class="input" value="">
                                 ...
                                 <!-- <td>
                                     <span>买家电话：</span>
                                     <input name="mobile" type="text"  class="input" value="">
                                 </td> -->
                                 <!-- <td class="range">
                                     <span >下单时间：</span>
    ...
    <form name="myform" action="{:U('Order/delete')}" method="post" class="J_ajaxForm">
        <div class="table_list">
            <table width="100%" cellspacing="0">
                <thead>
                <tr>
                    <td align="left" width="45" style="text-align:center">评论ID</td>
                    <td align="left" width="120" style="text-align:center">订单号</td>
                    <!-- <td align="left">支付号</td> -->
                    <td align="left" width="50" style="text-align:center">店铺ID</td>
                    <td align="left" width="100" style="text-align:center">店铺名称</td>
                    <td align="left" width="50" style="text-align:center">产品ID</td>
                    <!-- <td align="left">产品名称</td> -->
                    <td align="left"width="50" style="text-align:center">评论人ID</td>
                    <td align="left" width="100" style="text-align:center">评论人姓名</td>
                    <td align="left" width="100" style="text-align:center">评论人电话</td>
                    <td align="left" width="100" style="text-align:center">评论时间</td>
                    <td align="left" width="600" style="text-align:center">评论内容</td>
                ...
                <volist name="data" id="vo">
                    <tr>
                      ...
                      <td align="left" style="text-align:center">{$vo.order_sn}</td>
                      <td align="left" style="text-align:center">{$vo.shop_id}</td>
                      <td align="left" style="text-align:center">{$vo.shop_name}</td>
                      <td align="left" style="text-align:center">{$vo.product_id}</td>
                      <!-- <td align="left">{$vo.product_name}</td> -->
                      <td align="left" style="text-align:center">{$vo.userid}</td>
                      <td align="left" style="text-align:center">{$vo.username}</td>
                      <td align="left" style="text-align:center">{$vo.buyertel}</td>
                      <td align="left" style="text-align:center">{$vo.addtime|date="Y-m-d H:i",###}</td>
                      <td align="left" style="text-align:center">{$vo.content}</td>
