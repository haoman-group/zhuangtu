...
<div class="wrap J_check_wrap">
    ...
    <form name="searchform" action="" method="get" >
        ...
        <span class="mr10">
        <select name="type">
            <option value='1' >辅材名</option>
            <option value='2' >辅材分类</option>
            <option value='3' >品牌名称</option>
            <option value='4' >规格</option>
        </select>
        ...
        <div class="table_list">
            <table width="100%" cellspacing="0">
                ...
                <volist name="data" id="vo">
                    <tr>
                        <td align="left">{$i}</td>
                        <td align="center"><img src="{$vo.picture}" style="width:50px;"></td>
                        <td align="left">{$vo.name}</td>
                        <td align="left">{$vo.accessory_type}</td>
                        <td align="left">{$vo.brand}</td>
                        <td align="left">{$vo.norm}</td>
                        <td align="left">{$vo.unit_name}</td>
                        <td align="left">{$vo.unit_price}</td>
