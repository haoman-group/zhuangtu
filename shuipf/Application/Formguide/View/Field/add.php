...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      ...
      <li class="current"><a href="{:U("Field/add",array("formid"=>$formid))}">添加字段</a></li>
    </ul>
  </div>
  <div class="h_a">字段配置</div>
  <form name="myform" id="myform" action="{:U("Field/add")}" method="post" class="J_ajaxForm">
  ...
  <table width="100%">
    ...
    <div class="btn_wrap">
      <div class="btn_wrap_pd">             
        ...
        <input name="modelid" type="hidden" value="{$formid}" />
      </div>
    </div>
  </form>
</div>
